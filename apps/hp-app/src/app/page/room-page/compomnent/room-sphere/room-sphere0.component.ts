...
export class RoomSphere0Component implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    console.log("RoomSphere0Component::ngOnInit()", this.room_id)
  }
